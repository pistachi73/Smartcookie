  ...
  return (
    <PopoverPrimitive
      ...
      className={composeTailwindRenderProps(className, [
        "group/popover min-w-(--trigger-width) max-w-xs rounded-xl border bg-overlay text-overlay-fg shadow-xs outline-hidden transition-transform [--gutter:--spacing(6)] sm:text-sm dark:backdrop-saturate-200",

...
const radioVariants = cva(
  "flex items-center gap-2 px-2 py-1 text-base outline-none transition-all before:transition-all before:content-[''] before:size-4 before:bg-background before:rounded-full before:border ",
  {
    variants: {
      isDisabled: {
      ...
      isFocusVisible: {
        true: "before:ring-[4px] before:border-neutral-300  before:ring-neutral-300/40 dark:before:border-neutral-500 dark:before:ring-neutral-500/30",
      },
      isSelected: {

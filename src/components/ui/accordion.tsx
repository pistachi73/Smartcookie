...
>(({ className, children, ...props }, ref) => (
  <AccordionPrimitive.Header className="flex  px-1 py-2">
    <AccordionPrimitive.Trigger
      ref={ref}
      className={cn(
        "flex flex-1 items-center justify-between rounded-lg  px-2 py-2 font-medium transition-all [&[data-state=open]>svg]:rotate-180 hover:bg-background-base-highlight",
        className,
      )}
      {...props}
    >

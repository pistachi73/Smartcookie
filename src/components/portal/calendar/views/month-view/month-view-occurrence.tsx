...
export const MonthViewOccurrence = ({
  ...
  return (
    <DialogTrigger
      onOpenChange={(e) => {
        popoverProps?.onOpenChange?.(e);
      }}
    >
      <Button
        className={cn(
          "border border-transparent text-xs min-w-0 w-full h-6 p-0.5 px-1 rounded-md text-text-base hover:bg-base-highlight flex gap-1 items-center transition-colors cursor-pointer",
          className,
